<template>
  <div>
    ...
    <header class="carousel">
      ...
      <span
        :class="['carousel-item', currentSection === 'journalists' ? 'active' : '']"
        @click="currentSection = 'journalists'"
      >Periodistas</span>
    </header>
    ...
    <main class="content">
      ...
      <Periodista v-else-if="currentSection === 'journalists'" />
    </main>
  </div>
</template>
...
import Periodista from "@/components/AdminPanel/periodista.vue";
